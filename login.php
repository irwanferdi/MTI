...
<head>
    ...
    <title>Login Administrator | Arsip Dokumen Mubaligh Teknologi Indonesia</title>
...
<body>
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3>ARSIP DOKUMEN</h3>
                <h4>Mubaligh Teknologi Indonesia</h4>
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="periksa_login.php" method="POST" id="loginForm">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="password">Akses Sebagai</label>
    ...
    <p class="text-muted" style="color: black; font-weight: bold;">
        Copyright © <?php echo date('Y') ?>. Mubaligh Teknologi Indonesia
    </p>
</div>
        </div>   
    </div>
	...
	<body class="hold-transition login-page" style="background:url(gambar/depan/Background.png)
