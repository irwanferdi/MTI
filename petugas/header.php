...
<head>
    ...
    <title>Petugas - Sistem Arsip Dokumen</title>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../assets/img/logo/logo1.jpg" alt="" /></a>
                <strong><a href="index.html"><img src="../assets/img/logo/logo2.jpg" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="arsip.php" aria-expanded="false"> <span class="mini-click-non">Data Arsip Dokumen</span></a>
                        </li>

                        <li>
                            <a href="kategori.php" aria-expanded="false"> <span class="mini-click-non">Data Kategori</span></a>
                        </li>
                        
                        <li>
                            <a href="user.php" aria-expanded="false"><span class="mini-click-non">Data User</span></a>
                        </li>

                        <li>
                            <a href="riwayat.php" aria-expanded="false"><span class="mini-click-non">Riwayat Unduh</span></a>
                        </li>

                        <li>
                            <a href="gantipassword.php" aria-expanded="false"> <span class="mini-click-non">Ganti Password</span></a>
                        </li>

                        <li>
                            <a href="logout.php" aria-expanded="false"> <span class="mini-click-non">Logout</span></a>
                        </li>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">Sistem Arsip Dokumen</a></li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li>
                                    <a href="kategori.php" aria-expanded="false"> <span class="mini-click-non">Kategori</span></a>
                                </li>

                                <li>
                                    <a href="petugas.php" aria-expanded="false"> <span class="mini-click-non">Petugas</span></a>
                                </li>

                                <li>
                                    <a href="user.php" aria-expanded="false"><span class="mini-click-non">User</span></a>
                                </li>

                                <li>
                                    <a href="riwayat.php" aria-expanded="false"> <span class="mini-click-non">User</span></a>
                                </li>
