...
<head>
    ...
    <title>Admin - Sistem Arsip Dokumen</title>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="petugas.php" aria-expanded="false"><span class="mini-click-non">Data Petugas</span></a>
                        </li>
                        ...
                        <li>
                            <a href="riwayat.php" aria-expanded="false"> <span class="mini-click-non">Riwayat Unduhan</span></a>
                        </li>


                        <li>
                            <a href="gantipassword.php" aria-expanded="false"></span> <span class="mini-click-non">Ganti Password</span></a>
                        </li>
