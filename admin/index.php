                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="caption pro-sl-hd">
                                    <span class="caption-subject"><b>Grafik Unduhan Arsip Dokumen</b></span>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="actions graph-rp graph-rp-dl">
                                    <p>Grafik Jumlah Unduhan Arsip Dokumen Perhari Selama Sebulan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-cards-item">
                    <div class="single-product-image">
                        <a href="#">
                            ...
                            <img src="../assets/img/product/Profile.jpg" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-product-text">
                        ...
                        <h5>Admin</h5>
                        <p class="ctn-cards">Arsip Dokumen Jadi Lebih Efisien dan Efektif.</p>
                    </div>
                </div>
