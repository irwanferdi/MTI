        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.php"><img class="main-logo" src="../assets/img/logo/logo1.jpg" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mobile-menu">
                            <nav id="dropdown">
                                <ul class="mobile-menu-nav">
                                    ...
                                    <li>
                                        <a href="arsip.php" aria-expanded="false"><span class="mini-click-non">Data Arsip</span></a>
                                    </li>
